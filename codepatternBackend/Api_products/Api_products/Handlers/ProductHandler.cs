...
namespace Api_products.Handlers
{
    ...
    // vi har även använt oss av The Liskov Substitution Principle med hjälp utav vara interfaces. Det hjälper oss att förhindra modellhierarkier som inte överensstämmer med Open/Closed-principen.
    ...
    // alltså gör den här sidan bara ensak. 
